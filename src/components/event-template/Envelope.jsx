...
export default function Envelope({ name, onOpen, letterMark }) {
  ...
  return (
    <div className="envelope-stage">
      ...
      >
          ...
          <span className="envelope-body">
            ...
            >
              ...
              >
                ...
                >
                  {letterMark || "'My days would be incomplete without you — today, and forever.'"}
                </span>
              </span>
            </motion.span>
            <motion.span
        ...
        {!opening && <p className="envelope-hint">tap the seal to open it</p>}
      </motion.div>
    </div>
  );
}
